...
def load_fcs_file( fcs_file_name ):
    """
...
def write_fcs_file( fcs_vars, events, fcs_file_name, delimiter="," ):
    """
...
if __name__ == '__main__':
    ...
    while( files ):
        ...
        # It it's a file, process the file
            ...
            fcs_vars, events = load_fcs_file( fcs_file_name )
            write_fcs_file( fcs_vars, events, fcs_file_name, delimiter )
