class _ESS(object):
    ...
    - component_centers            - The centers of the clusters
    - component_precisions         - Covariance matrices of the clusters
    - mixing_weights               - The mixing weights
    - responsabilities_scaled      - Responsabilities scaled by the scale
                                     variable
